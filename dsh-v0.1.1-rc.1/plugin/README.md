...
在 DSH 中执行（`file:` 协议让包管理器落实依赖并录入装配栈）：
...
- 依赖闭包、装卸命令、API 契约与验证状态见 [MANIFEST.md](./MANIFEST.md)；版本变更见 [CHANGELOG.md](./CHANGELOG.md)。
- 定制化说明见 [CUSTOMIZATION.md](./CUSTOMIZATION.md)。
